...
export default function CVPreview({ lang, version }: CVPreviewProps) {
  ...
  return (
    <div className="w-full h-full min-h-[1100px] rounded-2xl overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.3)] border border-white/10">
      <iframe src={`/api/cv/download/${lang}${versionQuery}`} width="100%" height="1100px" className="border-none" />
    </div>
  );
}
